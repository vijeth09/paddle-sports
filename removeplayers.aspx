...
<head runat="server">
    <title>REMOVE TEAM FROM TOURNAMENT</title>
    <meta charset="utf-8" />
    ...
    <form id="form1" runat="server">
        ...
        <div class="container shadow mb-2 bg-transparent">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <h4 class="text-center mx-auto d-block align-middle  ">REMOVE TEAM FROM TOURNAMENT</h4>
                </div>
                <div class="col-sm-4">
        ...
        <div class="container-fluid bg-secondary">
            ...
            <div class="card-group-vertical">
                ...
                <div class="card text-white text-center  bg-dark">
                    <div class="card-body  d-inline">
                        <h3>PLEASE REMOVE THE SELECTED TEAM FROM AN EVENT</h3>
                        <br />
